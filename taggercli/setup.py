...
setup(
    ...
    install_requires=[
        "taggercore @ git+https://github.com/christi3k/tagger.git#egg=taggercore&subdirectory=taggercore",
        "typer",
        "rich",
        "jinja2",
    ],
    ...
    author="IT-experts / Christie Koehler",
    author_email="ck@christi3k.net",
